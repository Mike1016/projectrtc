 ...
 * Package Name:com.bus.plugin
 * Date:2016��4��11������11:02:08
 * Copyright (c) 2016, chenzhou1025@126.com All Rights Reserved.
 *
 */

package com.daka.plugin;
...
import com.daka.util.ReflectHelper;
...
public class PagePlugin implements Interceptor
{
    ...
    private static String dialect = ""; // ��ݿⷽ��

    private static String pageSqlId = ""; // mapper.xml����Ҫ���ص�ID(����ƥ��)
        ...
        if (ivk.getTarget() instanceof RoutingStatementHandler)
        {
            ...
            { // ������Ҫ��ҳ��SQL
                ...
                else
                {
                    ...
                    // ") as tmp_count"; //��¼ͳ��
                    String countSql = "select count(0) from (" + sql + ")  tmp_count"; // ��¼ͳ��
                                                                                       // ==
                                                                                       // oracle
                                                                                       // ��
                                                                                       // as
                    ...
                    { // ����Ϊĳ��ʵ�壬��ʵ��ӵ��Page����
                        ...
                        if (pageField != null)
                        {
                            ...
                            page.setTotalResult(count);
                            ReflectHelper.setValueByFieldName(parameterObject, "page", page); // ͨ���䣬��ʵ��������÷�ҳ����
                        }
                        else
                        {
            ...
            for (int i = 0; i < parameterMappings.size(); i++)
            {
                ...
                if (parameterMapping.getMode() != ParameterMode.OUT)
                {
                        ...
                        && boundSql.hasAdditionalParameter(prop.getName()))
                    {
                        ...
                        {
                            value =
                                configuration.newMetaObject(value).getValue(propertyName.substring(prop.getName()
                                    .length()));
                        }
                    }
                    else
