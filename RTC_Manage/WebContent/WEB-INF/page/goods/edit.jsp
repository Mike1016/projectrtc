...
<strong>[基础属性]</strong>
			...
			<div class="layui-input-inline">
				<select name="goodsTypeId" id="goodsTypeId" lay-verify="required">
					<c:forEach items="${goodsType}" var="item">
						<option <c:if test="${item.id== goodsInfo.goodsTypeId}">selected="selected"</c:if>   value="${item.id }">${item.typeName }</option>
					</c:forEach>
				</select>
			</div>
		</div>
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-inline">
				<input type="number" class="layui-input" name="goodsOriginalPrice" id="goodsOriginalPrice" value="${goodsInfo.goodsOriginalPrice }">
			</div>
		</div>
		<div class="layui-form-item">
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-inline">
				<input type="text" required  readonly="readonly"  lay-verify="required" name="goodsDiscountRate" id="goodsDiscountRate"
		...
		<div class="layui-form-item">
			...
			<div class="layui-input-inline">
			<input type="number" name="goodsCount" class="layui-input" id="goodsCount" value="${ goodsInfo.goodsCount}">
			</div>
		</div>
		<div class="layui-form-item">
		...
		<c:forEach items="${goodsInfo.goodsAttrs }" var="item">
			<tr style="width: 47%">
				<td width="30%"  style="padding: 5px"><input class="layui-input" value="${item.attrName }" /> </td>
				<td width="30%"  style="padding: 5px"><input class="layui-input" value="${item.attrValue }" /> </td>
				<td width="30%"></td>
			</tr>
		</c:forEach>
		</table>
