...
<script type="text/html" id="state">
	{{# if (d.state== 0) { }}
	<span style='color:blue'>正在分红</span>

	{{# } else if(d.state== 1) { }}
	<span style='color:green'>分红完成</span>

	{{# } else if(d.state== 2) { }}
	<span style='color:#660000'>提出分红</span>
...
//    			+"<button class='layui-btn layui-btn-xs'  id='user_delete' onclick=del('{{d.id}}')>删除</button>";
		tableInstance = table.render({
		    ...
		    ,url: '../fiveInvest/queryData.do' //数据接口
		    ,response: {
		    ...
		    ,cols: [[//表头
		      ...
		      ,{field: 'origin_account', title: '原始金额', width:"15%"}
		      ,{field: 'dynamic_account', title: '每日累加金额', width:"15%"}
		      ,{field: 'limit_account', title: '返利额度', width:"15%"}
